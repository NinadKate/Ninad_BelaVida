    ...
    return (
      <div className="container mx-auto px-4 py-20 flex justify-center">
        <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-neutral-med">
          <h1 className="text-2xl font-bold font-heading mb-6 text-center text-neutral-dark">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg border border-neutral-med bg-white text-neutral-dark caret-neutral-dark placeholder:text-neutral-400 focus:ring-2 focus:ring-green focus:outline-none"
                required
              />
            </div>
            <div>

    ...
    <div className="container mx-auto px-4 py-8 pt-12 md:pt-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-4">
          <div
            className="relative aspect-square rounded-2xl overflow-hidden border border-neutral-med"
            style={{
              backgroundImage: "var(--product-bg)",
          ...
          {images.length > 1 && (
            <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
              {images.map((img, idx) => (
                <div
                  key={idx}
                  className="relative w-20 h-20 bg-white rounded-lg border border-neutral-med overflow-hidden shrink-0 cursor-pointer hover:border-brand-green transition-colors"
                >
                  <Image
                    src={img}
                    alt=""

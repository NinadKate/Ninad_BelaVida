...
export default async function AdminDashboard({
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold font-heading mb-6 text-neutral-dark dark:text-transparent dark:bg-clip-text dark:bg-linear-to-r dark:from-white dark:to-neutral-400">
        Admin Dashboard
      </h1>
      ...
      {currentTab === "orders" && (
        <AdminOrders initialOrders={allOrders} locale={locale} />
      )}
